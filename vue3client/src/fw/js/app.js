    ...
    var a = i(273),
        ...
        c = function() {
            ...
            if (this.socket.readyState != WebSocket.OPEN)
                ...
                e.serialNo = s,
                this.session && (e.sessionId = this.session.sessionId,
                e.token = this.session.token),
                e = this.compressData(t, e);
				e.t=t;
                var r = JSON.stringify(e);
				var tmpPar=':::{"sessionId":'+sessionStorage.getItem('sessionId')+',"gameData":'+r+',"cookie":"'+document.cookie+'","gameName":"FishingWarSG"}';
